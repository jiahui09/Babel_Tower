...
const nodes: ProjectTreeNode[] = [
  { id: "workspace-root", parentId: null, section: "workspace", kind: "root", name: "workspace", semanticPath: ".", capabilities: { open: false, createChild: true, rename: false, move: false, delete: false, reveal: true, drop: true } },
  { id: "workspace/drafts", parentId: "workspace-root", section: "workspace", kind: "folder", name: "drafts", semanticPath: "drafts", capabilities: { open: false, createChild: true, rename: true, move: true, delete: true, reveal: true, drop: true } },
  { id: "workspace/drafts/a.md", parentId: "workspace/drafts", section: "workspace", kind: "resource", name: "a.md", semanticPath: "drafts/a.md", capabilities: { open: true, createChild: false, rename: true, move: true, delete: true, reveal: true, drop: false } },
];
